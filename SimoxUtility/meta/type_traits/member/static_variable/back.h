...
namespace simox::meta::member::static_variable::back::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::back));
...
namespace simox::meta::member::static_variable::back
{
...
{
    template<class T>
    static constexpr bool back = ::simox::meta::member::static_variable::back::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept back = ::simox::meta::member::static_variable::back::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using back = ::simox::meta::member::static_variable::back::type_t<T>;
}
