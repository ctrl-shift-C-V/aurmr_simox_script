...
namespace simox::meta::member::static_variable::max::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::max
{
...
{
    template<class T>
    static constexpr bool max = ::simox::meta::member::static_variable::max::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept max = ::simox::meta::member::static_variable::max::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using max = ::simox::meta::member::static_variable::max::type_t<T>;
}
