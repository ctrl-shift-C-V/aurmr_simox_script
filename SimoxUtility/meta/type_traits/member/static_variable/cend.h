...
namespace simox::meta::member::static_variable::cend::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::cend
{
...
{
    template<class T>
    static constexpr bool cend = ::simox::meta::member::static_variable::cend::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept cend = ::simox::meta::member::static_variable::cend::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using cend = ::simox::meta::member::static_variable::cend::type_t<T>;
}
