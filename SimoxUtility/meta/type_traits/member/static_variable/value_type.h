...
namespace simox::meta::member::static_variable::value_type::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::value_type));
...
namespace simox::meta::member::static_variable::value_type
{
...
{
    template<class T>
    static constexpr bool value_type = ::simox::meta::member::static_variable::value_type::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept value_type = ::simox::meta::member::static_variable::value_type::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using value_type = ::simox::meta::member::static_variable::value_type::type_t<T>;
}
