...
namespace simox::meta::member::static_variable::empty::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::empty));
...
namespace simox::meta::member::static_variable::empty
{
...
{
    template<class T>
    static constexpr bool empty = ::simox::meta::member::static_variable::empty::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept empty = ::simox::meta::member::static_variable::empty::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using empty = ::simox::meta::member::static_variable::empty::type_t<T>;
}
