...
namespace simox::meta::member::static_variable::extract::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::extract));
...
namespace simox::meta::member::static_variable::extract
{
...
{
    template<class T>
    static constexpr bool extract = ::simox::meta::member::static_variable::extract::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept extract = ::simox::meta::member::static_variable::extract::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using extract = ::simox::meta::member::static_variable::extract::type_t<T>;
}
