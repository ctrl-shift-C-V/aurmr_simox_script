...
namespace simox::meta::member::static_variable::val::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::val));
...
namespace simox::meta::member::static_variable::val
{
...
{
    template<class T>
    static constexpr bool val = ::simox::meta::member::static_variable::val::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept val = ::simox::meta::member::static_variable::val::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using val = ::simox::meta::member::static_variable::val::type_t<T>;
}
