...
namespace simox::meta::member::static_variable::push_back::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::push_back
{
...
{
    template<class T>
    static constexpr bool push_back = ::simox::meta::member::static_variable::push_back::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept push_back = ::simox::meta::member::static_variable::push_back::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using push_back = ::simox::meta::member::static_variable::push_back::type_t<T>;
}
