...
namespace simox::meta::member::static_variable::size_type::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::size_type));
...
namespace simox::meta::member::static_variable::size_type
{
...
{
    template<class T>
    static constexpr bool size_type = ::simox::meta::member::static_variable::size_type::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept size_type = ::simox::meta::member::static_variable::size_type::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using size_type = ::simox::meta::member::static_variable::size_type::type_t<T>;
}
