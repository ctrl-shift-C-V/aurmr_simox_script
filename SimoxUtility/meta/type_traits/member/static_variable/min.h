...
namespace simox::meta::member::static_variable::min::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::min));
...
namespace simox::meta::member::static_variable::min
{
...
{
    template<class T>
    static constexpr bool min = ::simox::meta::member::static_variable::min::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept min = ::simox::meta::member::static_variable::min::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using min = ::simox::meta::member::static_variable::min::type_t<T>;
}
