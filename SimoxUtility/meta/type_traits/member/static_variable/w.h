...
namespace simox::meta::member::static_variable::w::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::w));
...
namespace simox::meta::member::static_variable::w
{
...
{
    template<class T>
    static constexpr bool w = ::simox::meta::member::static_variable::w::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept w = ::simox::meta::member::static_variable::w::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using w = ::simox::meta::member::static_variable::w::type_t<T>;
}
