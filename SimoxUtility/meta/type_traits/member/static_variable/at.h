...
namespace simox::meta::member::static_variable::at::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::at
{
...
{
    template<class T>
    static constexpr bool at = ::simox::meta::member::static_variable::at::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept at = ::simox::meta::member::static_variable::at::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using at = ::simox::meta::member::static_variable::at::type_t<T>;
}
