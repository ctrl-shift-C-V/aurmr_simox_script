...
namespace simox::meta::member::static_variable::value_t::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::value_t));
...
namespace simox::meta::member::static_variable::value_t
{
...
{
    template<class T>
    static constexpr bool value_t = ::simox::meta::member::static_variable::value_t::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept value_t = ::simox::meta::member::static_variable::value_t::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using value_t = ::simox::meta::member::static_variable::value_t::type_t<T>;
}
