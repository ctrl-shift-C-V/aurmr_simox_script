...
namespace simox::meta::member::static_variable::points::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::points));
...
namespace simox::meta::member::static_variable::points
{
...
{
    template<class T>
    static constexpr bool points = ::simox::meta::member::static_variable::points::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept points = ::simox::meta::member::static_variable::points::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using points = ::simox::meta::member::static_variable::points::type_t<T>;
}
