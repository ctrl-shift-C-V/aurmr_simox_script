...
namespace simox::meta::member::static_variable::insert::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::insert));
...
namespace simox::meta::member::static_variable::insert
{
...
{
    template<class T>
    static constexpr bool insert = ::simox::meta::member::static_variable::insert::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept insert = ::simox::meta::member::static_variable::insert::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using insert = ::simox::meta::member::static_variable::insert::type_t<T>;
}
