...
namespace simox::meta::member::static_variable::vertices::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::vertices));
...
namespace simox::meta::member::static_variable::vertices
{
...
{
    template<class T>
    static constexpr bool vertices = ::simox::meta::member::static_variable::vertices::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept vertices = ::simox::meta::member::static_variable::vertices::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using vertices = ::simox::meta::member::static_variable::vertices::type_t<T>;
}
