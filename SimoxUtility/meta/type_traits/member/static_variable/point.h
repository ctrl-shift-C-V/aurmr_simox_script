...
namespace simox::meta::member::static_variable::point::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::point));
...
namespace simox::meta::member::static_variable::point
{
...
{
    template<class T>
    static constexpr bool point = ::simox::meta::member::static_variable::point::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept point = ::simox::meta::member::static_variable::point::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using point = ::simox::meta::member::static_variable::point::type_t<T>;
}
