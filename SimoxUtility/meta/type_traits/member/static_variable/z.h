...
namespace simox::meta::member::static_variable::z::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::z));
...
namespace simox::meta::member::static_variable::z
{
...
{
    template<class T>
    static constexpr bool z = ::simox::meta::member::static_variable::z::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept z = ::simox::meta::member::static_variable::z::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using z = ::simox::meta::member::static_variable::z::type_t<T>;
}
