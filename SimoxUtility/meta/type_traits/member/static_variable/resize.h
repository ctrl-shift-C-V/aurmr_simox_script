...
namespace simox::meta::member::static_variable::resize::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::resize));
...
namespace simox::meta::member::static_variable::resize
{
...
{
    template<class T>
    static constexpr bool resize = ::simox::meta::member::static_variable::resize::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept resize = ::simox::meta::member::static_variable::resize::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using resize = ::simox::meta::member::static_variable::resize::type_t<T>;
}
