...
namespace simox::meta::member::static_variable::qz::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::qz));
...
namespace simox::meta::member::static_variable::qz
{
...
{
    template<class T>
    static constexpr bool qz = ::simox::meta::member::static_variable::qz::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept qz = ::simox::meta::member::static_variable::qz::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using qz = ::simox::meta::member::static_variable::qz::type_t<T>;
}
