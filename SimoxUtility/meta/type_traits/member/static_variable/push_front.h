...
namespace simox::meta::member::static_variable::push_front::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::push_front));
...
namespace simox::meta::member::static_variable::push_front
{
...
{
    template<class T>
    static constexpr bool push_front = ::simox::meta::member::static_variable::push_front::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept push_front = ::simox::meta::member::static_variable::push_front::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using push_front = ::simox::meta::member::static_variable::push_front::type_t<T>;
}
