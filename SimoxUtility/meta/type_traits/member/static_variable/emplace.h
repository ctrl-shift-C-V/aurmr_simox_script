...
namespace simox::meta::member::static_variable::emplace::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::emplace));
...
namespace simox::meta::member::static_variable::emplace
{
...
{
    template<class T>
    static constexpr bool emplace = ::simox::meta::member::static_variable::emplace::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept emplace = ::simox::meta::member::static_variable::emplace::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using emplace = ::simox::meta::member::static_variable::emplace::type_t<T>;
}
