...
namespace simox::meta::member::static_variable::swap::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::swap
{
...
{
    template<class T>
    static constexpr bool swap = ::simox::meta::member::static_variable::swap::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept swap = ::simox::meta::member::static_variable::swap::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using swap = ::simox::meta::member::static_variable::swap::type_t<T>;
}
