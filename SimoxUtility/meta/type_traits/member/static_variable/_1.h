...
namespace simox::meta::member::static_variable::_1::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::_1));
...
namespace simox::meta::member::static_variable::_1
{
...
{
    template<class T>
    static constexpr bool _1 = ::simox::meta::member::static_variable::_1::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept _1 = ::simox::meta::member::static_variable::_1::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using _1 = ::simox::meta::member::static_variable::_1::type_t<T>;
}
