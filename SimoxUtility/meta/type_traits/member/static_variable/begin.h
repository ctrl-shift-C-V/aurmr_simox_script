...
namespace simox::meta::member::static_variable::begin::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::begin));
...
namespace simox::meta::member::static_variable::begin
{
...
{
    template<class T>
    static constexpr bool begin = ::simox::meta::member::static_variable::begin::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept begin = ::simox::meta::member::static_variable::begin::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using begin = ::simox::meta::member::static_variable::begin::type_t<T>;
}
