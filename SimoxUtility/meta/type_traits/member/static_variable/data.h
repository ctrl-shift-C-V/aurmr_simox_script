...
namespace simox::meta::member::static_variable::data::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::data));
...
namespace simox::meta::member::static_variable::data
{
...
{
    template<class T>
    static constexpr bool data = ::simox::meta::member::static_variable::data::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept data = ::simox::meta::member::static_variable::data::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using data = ::simox::meta::member::static_variable::data::type_t<T>;
}
