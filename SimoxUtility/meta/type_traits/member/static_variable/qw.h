...
namespace simox::meta::member::static_variable::qw::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::qw
{
...
{
    template<class T>
    static constexpr bool qw = ::simox::meta::member::static_variable::qw::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept qw = ::simox::meta::member::static_variable::qw::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using qw = ::simox::meta::member::static_variable::qw::type_t<T>;
}
