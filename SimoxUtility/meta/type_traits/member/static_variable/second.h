...
namespace simox::meta::member::static_variable::second::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::second));
...
namespace simox::meta::member::static_variable::second
{
...
{
    template<class T>
    static constexpr bool second = ::simox::meta::member::static_variable::second::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept second = ::simox::meta::member::static_variable::second::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using second = ::simox::meta::member::static_variable::second::type_t<T>;
}
