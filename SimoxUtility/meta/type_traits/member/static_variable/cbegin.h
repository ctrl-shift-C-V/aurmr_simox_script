...
namespace simox::meta::member::static_variable::cbegin::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::cbegin
{
...
{
    template<class T>
    static constexpr bool cbegin = ::simox::meta::member::static_variable::cbegin::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept cbegin = ::simox::meta::member::static_variable::cbegin::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using cbegin = ::simox::meta::member::static_variable::cbegin::type_t<T>;
}
