...
namespace simox::meta::member::static_variable::reserve::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::reserve));
...
namespace simox::meta::member::static_variable::reserve
{
...
{
    template<class T>
    static constexpr bool reserve = ::simox::meta::member::static_variable::reserve::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept reserve = ::simox::meta::member::static_variable::reserve::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using reserve = ::simox::meta::member::static_variable::reserve::type_t<T>;
}
