...
namespace simox::meta::member::static_variable::_2::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::_2));
...
namespace simox::meta::member::static_variable::_2
{
...
{
    template<class T>
    static constexpr bool _2 = ::simox::meta::member::static_variable::_2::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept _2 = ::simox::meta::member::static_variable::_2::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using _2 = ::simox::meta::member::static_variable::_2::type_t<T>;
}
