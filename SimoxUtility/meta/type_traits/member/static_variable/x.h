...
namespace simox::meta::member::static_variable::x::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::x));
...
namespace simox::meta::member::static_variable::x
{
...
{
    template<class T>
    static constexpr bool x = ::simox::meta::member::static_variable::x::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept x = ::simox::meta::member::static_variable::x::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using x = ::simox::meta::member::static_variable::x::type_t<T>;
}
