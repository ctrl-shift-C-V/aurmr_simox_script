...
namespace simox::meta::member::static_variable::size_t::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::size_t));
...
namespace simox::meta::member::static_variable::size_t
{
...
{
    template<class T>
    static constexpr bool size_t = ::simox::meta::member::static_variable::size_t::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept size_t = ::simox::meta::member::static_variable::size_t::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using size_t = ::simox::meta::member::static_variable::size_t::type_t<T>;
}
