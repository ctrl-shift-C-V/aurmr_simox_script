...
namespace simox::meta::member::static_variable::qy::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::qy
{
...
{
    template<class T>
    static constexpr bool qy = ::simox::meta::member::static_variable::qy::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept qy = ::simox::meta::member::static_variable::qy::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using qy = ::simox::meta::member::static_variable::qy::type_t<T>;
}
