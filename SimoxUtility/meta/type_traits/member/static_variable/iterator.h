...
namespace simox::meta::member::static_variable::iterator::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::iterator
{
...
{
    template<class T>
    static constexpr bool iterator = ::simox::meta::member::static_variable::iterator::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept iterator = ::simox::meta::member::static_variable::iterator::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using iterator = ::simox::meta::member::static_variable::iterator::type_t<T>;
}
