...
namespace simox::meta::member::static_variable::size::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::size));
...
namespace simox::meta::member::static_variable::size
{
...
{
    template<class T>
    static constexpr bool size = ::simox::meta::member::static_variable::size::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept size = ::simox::meta::member::static_variable::size::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using size = ::simox::meta::member::static_variable::size::type_t<T>;
}
