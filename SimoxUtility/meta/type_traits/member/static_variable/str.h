...
namespace simox::meta::member::static_variable::str::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::str));
...
namespace simox::meta::member::static_variable::str
{
...
{
    template<class T>
    static constexpr bool str = ::simox::meta::member::static_variable::str::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept str = ::simox::meta::member::static_variable::str::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using str = ::simox::meta::member::static_variable::str::type_t<T>;
}
