...
namespace simox::meta::member::static_variable::first::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::first));
...
namespace simox::meta::member::static_variable::first
{
...
{
    template<class T>
    static constexpr bool first = ::simox::meta::member::static_variable::first::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept first = ::simox::meta::member::static_variable::first::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using first = ::simox::meta::member::static_variable::first::type_t<T>;
}
