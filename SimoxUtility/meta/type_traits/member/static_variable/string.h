...
namespace simox::meta::member::static_variable::string::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::string));
...
namespace simox::meta::member::static_variable::string
{
...
{
    template<class T>
    static constexpr bool string = ::simox::meta::member::static_variable::string::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept string = ::simox::meta::member::static_variable::string::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using string = ::simox::meta::member::static_variable::string::type_t<T>;
}
