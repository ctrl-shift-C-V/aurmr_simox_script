...
namespace simox::meta::member::static_variable::h::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::h));
...
namespace simox::meta::member::static_variable::h
{
...
{
    template<class T>
    static constexpr bool h = ::simox::meta::member::static_variable::h::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept h = ::simox::meta::member::static_variable::h::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using h = ::simox::meta::member::static_variable::h::type_t<T>;
}
