...
namespace simox::meta::member::static_variable::c_str::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::c_str));
...
namespace simox::meta::member::static_variable::c_str
{
...
{
    template<class T>
    static constexpr bool c_str = ::simox::meta::member::static_variable::c_str::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept c_str = ::simox::meta::member::static_variable::c_str::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using c_str = ::simox::meta::member::static_variable::c_str::type_t<T>;
}
