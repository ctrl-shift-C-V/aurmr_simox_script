...
namespace simox::meta::member::static_variable::y::impl
{
    template<class Type>
...
namespace simox::meta::member::static_variable::y
{
...
{
    template<class T>
    static constexpr bool y = ::simox::meta::member::static_variable::y::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept y = ::simox::meta::member::static_variable::y::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using y = ::simox::meta::member::static_variable::y::type_t<T>;
}
