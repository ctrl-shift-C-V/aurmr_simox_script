...
namespace simox::meta::member::static_variable::npos::impl
{
    template<class Type>
    Type type_fn(const Type*);
    template<class T>
    using var_t = decltype(type_fn(&T::npos));
...
namespace simox::meta::member::static_variable::npos
{
...
{
    template<class T>
    static constexpr bool npos = ::simox::meta::member::static_variable::npos::exists_v<T>;
}
//concept
namespace simox::meta::member::static_variable::ccept
{
    template<class T>
    concept npos = ::simox::meta::member::static_variable::npos::exists_v<T>;
}
//type_t
namespace simox::meta::member::static_variable::type_t
{
    template<class T>
    using npos = ::simox::meta::member::static_variable::npos::type_t<T>;
}
