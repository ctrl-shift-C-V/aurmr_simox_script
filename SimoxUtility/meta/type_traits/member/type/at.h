...
namespace simox::meta::member::type::at::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::at > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::at > >
    {
        using type = typename T::at;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::at
{
...
{
    template<class T>
    static constexpr bool at = ::simox::meta::member::type::at::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept at = ::simox::meta::member::type::at::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using at = ::simox::meta::member::type::at::type_t<T>;
}
