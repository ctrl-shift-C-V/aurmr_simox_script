...
namespace simox::meta::member::type::str::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::str > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::str > >
    {
        using type = typename T::str;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::str
{
...
{
    template<class T>
    static constexpr bool str = ::simox::meta::member::type::str::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept str = ::simox::meta::member::type::str::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using str = ::simox::meta::member::type::str::type_t<T>;
}
