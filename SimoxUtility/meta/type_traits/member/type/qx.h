...
namespace simox::meta::member::type::qx::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::qx > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::qx > >
    {
        using type = typename T::qx;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::qx
{
...
{
    template<class T>
    static constexpr bool qx = ::simox::meta::member::type::qx::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept qx = ::simox::meta::member::type::qx::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using qx = ::simox::meta::member::type::qx::type_t<T>;
}
