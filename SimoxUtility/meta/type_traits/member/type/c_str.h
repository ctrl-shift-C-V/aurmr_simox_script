...
namespace simox::meta::member::type::c_str::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::c_str > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::c_str > >
    {
        using type = typename T::c_str;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::c_str
{
...
{
    template<class T>
    static constexpr bool c_str = ::simox::meta::member::type::c_str::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept c_str = ::simox::meta::member::type::c_str::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using c_str = ::simox::meta::member::type::c_str::type_t<T>;
}
