...
namespace simox::meta::member::type::back::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::back > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::back > >
    {
        using type = typename T::back;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::back
{
...
{
    template<class T>
    static constexpr bool back = ::simox::meta::member::type::back::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept back = ::simox::meta::member::type::back::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using back = ::simox::meta::member::type::back::type_t<T>;
}
