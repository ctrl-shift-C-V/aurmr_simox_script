...
namespace simox::meta::member::type::qw::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::qw > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::qw > >
    {
        using type = typename T::qw;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::qw
{
...
{
    template<class T>
    static constexpr bool qw = ::simox::meta::member::type::qw::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept qw = ::simox::meta::member::type::qw::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using qw = ::simox::meta::member::type::qw::type_t<T>;
}
