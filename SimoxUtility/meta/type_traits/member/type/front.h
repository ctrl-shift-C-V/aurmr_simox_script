...
namespace simox::meta::member::type::front::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::front > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::front > >
    {
        using type = typename T::front;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::front
{
...
{
    template<class T>
    static constexpr bool front = ::simox::meta::member::type::front::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept front = ::simox::meta::member::type::front::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using front = ::simox::meta::member::type::front::type_t<T>;
}
