...
namespace simox::meta::member::type::val::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::val > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::val > >
    {
        using type = typename T::val;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::val
{
...
{
    template<class T>
    static constexpr bool val = ::simox::meta::member::type::val::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept val = ::simox::meta::member::type::val::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using val = ::simox::meta::member::type::val::type_t<T>;
}
