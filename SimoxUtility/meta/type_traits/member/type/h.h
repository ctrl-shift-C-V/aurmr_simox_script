...
namespace simox::meta::member::type::h::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::h > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::h > >
    {
        using type = typename T::h;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::h
{
...
{
    template<class T>
    static constexpr bool h = ::simox::meta::member::type::h::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept h = ::simox::meta::member::type::h::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using h = ::simox::meta::member::type::h::type_t<T>;
}
