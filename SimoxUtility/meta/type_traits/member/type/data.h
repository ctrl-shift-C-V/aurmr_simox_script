...
namespace simox::meta::member::type::data::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::data > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::data > >
    {
        using type = typename T::data;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::data
{
...
{
    template<class T>
    static constexpr bool data = ::simox::meta::member::type::data::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept data = ::simox::meta::member::type::data::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using data = ::simox::meta::member::type::data::type_t<T>;
}
