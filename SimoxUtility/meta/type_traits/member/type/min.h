...
namespace simox::meta::member::type::min::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::min > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::min > >
    {
        using type = typename T::min;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::min
{
...
{
    template<class T>
    static constexpr bool min = ::simox::meta::member::type::min::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept min = ::simox::meta::member::type::min::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using min = ::simox::meta::member::type::min::type_t<T>;
}
