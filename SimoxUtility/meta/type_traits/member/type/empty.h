...
namespace simox::meta::member::type::empty::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::empty > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::empty > >
    {
        using type = typename T::empty;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::empty
{
...
{
    template<class T>
    static constexpr bool empty = ::simox::meta::member::type::empty::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept empty = ::simox::meta::member::type::empty::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using empty = ::simox::meta::member::type::empty::type_t<T>;
}
