...
namespace simox::meta::member::type::npos::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::npos > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::npos > >
    {
        using type = typename T::npos;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::npos
{
...
{
    template<class T>
    static constexpr bool npos = ::simox::meta::member::type::npos::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept npos = ::simox::meta::member::type::npos::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using npos = ::simox::meta::member::type::npos::type_t<T>;
}
