...
namespace simox::meta::member::type::max::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::max > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::max > >
    {
        using type = typename T::max;
    };
}

//meta fncs namespaced by class
namespace simox::meta::member::type::max
{
...
{
    template<class T>
    static constexpr bool max = ::simox::meta::member::type::max::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept max = ::simox::meta::member::type::max::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using max = ::simox::meta::member::type::max::type_t<T>;
}
