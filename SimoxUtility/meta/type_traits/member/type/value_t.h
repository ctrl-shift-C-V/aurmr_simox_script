...
namespace simox::meta::member::type::value_t::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::value_t > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::value_t > >
    {
...
namespace simox::meta::member::type::value_t
{
...
{
    template<class T>
    static constexpr bool value_t = ::simox::meta::member::type::value_t::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept value_t = ::simox::meta::member::type::value_t::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using value_t = ::simox::meta::member::type::value_t::type_t<T>;
}
