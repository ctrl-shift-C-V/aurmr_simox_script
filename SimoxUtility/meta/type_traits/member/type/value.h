...
namespace simox::meta::member::type::value::impl
{
    template<class T, class = void>
    struct member_type_exists : std::false_type
    {};
    template<class T>
    struct member_type_exists < T, std::void_t < typename T::value > > : std::true_type
    {};
    ...
    template<class T>
    struct member_type_type < T, std::void_t < typename T::value > >
    {
...
namespace simox::meta::member::type::value
{
...
{
    template<class T>
    static constexpr bool value = ::simox::meta::member::type::value::exists_v<T>;
}
//concept
namespace simox::meta::member::type::ccept
{
    template<class T>
    concept value = ::simox::meta::member::type::value::exists_v<T>;
}
//type_t
namespace simox::meta::member::type::type_t
{
    template<class T>
    using value = ::simox::meta::member::type::value::type_t<T>;
}
