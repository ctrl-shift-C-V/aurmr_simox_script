...
namespace simox::meta::member::static_method::value::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::value));
...
namespace simox::meta::member::static_method::value
{
...
{
    template<class T>
    static constexpr bool value = ::simox::meta::member::static_method::value::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept value = ::simox::meta::member::static_method::value::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using value = simox::meta::member::static_method::value::return_type_t<T>;
}
