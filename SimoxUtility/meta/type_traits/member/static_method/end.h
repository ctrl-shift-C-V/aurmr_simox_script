...
namespace simox::meta::member::static_method::end::impl
{
...
namespace simox::meta::member::static_method::end
{
...
{
    template<class T>
    static constexpr bool end = ::simox::meta::member::static_method::end::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept end = ::simox::meta::member::static_method::end::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using end = simox::meta::member::static_method::end::return_type_t<T>;
}
