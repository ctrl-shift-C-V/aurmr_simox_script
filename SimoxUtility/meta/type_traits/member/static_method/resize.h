...
namespace simox::meta::member::static_method::resize::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::resize));
...
namespace simox::meta::member::static_method::resize
{
...
{
    template<class T>
    static constexpr bool resize = ::simox::meta::member::static_method::resize::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept resize = ::simox::meta::member::static_method::resize::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using resize = simox::meta::member::static_method::resize::return_type_t<T>;
}
