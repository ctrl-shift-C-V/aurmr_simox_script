...
namespace simox::meta::member::static_method::emplace_front::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::emplace_front));
...
namespace simox::meta::member::static_method::emplace_front
{
...
{
    template<class T>
    static constexpr bool emplace_front = ::simox::meta::member::static_method::emplace_front::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept emplace_front = ::simox::meta::member::static_method::emplace_front::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using emplace_front = simox::meta::member::static_method::emplace_front::return_type_t<T>;
}
