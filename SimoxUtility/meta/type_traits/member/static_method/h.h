...
namespace simox::meta::member::static_method::h::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::h));
...
namespace simox::meta::member::static_method::h
{
...
{
    template<class T>
    static constexpr bool h = ::simox::meta::member::static_method::h::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept h = ::simox::meta::member::static_method::h::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using h = simox::meta::member::static_method::h::return_type_t<T>;
}
