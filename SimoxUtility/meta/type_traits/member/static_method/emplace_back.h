...
namespace simox::meta::member::static_method::emplace_back::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::emplace_back));
...
namespace simox::meta::member::static_method::emplace_back
{
...
{
    template<class T>
    static constexpr bool emplace_back = ::simox::meta::member::static_method::emplace_back::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept emplace_back = ::simox::meta::member::static_method::emplace_back::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using emplace_back = simox::meta::member::static_method::emplace_back::return_type_t<T>;
}
