...
namespace simox::meta::member::static_method::str::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::str));
...
namespace simox::meta::member::static_method::str
{
...
{
    template<class T>
    static constexpr bool str = ::simox::meta::member::static_method::str::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept str = ::simox::meta::member::static_method::str::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using str = simox::meta::member::static_method::str::return_type_t<T>;
}
