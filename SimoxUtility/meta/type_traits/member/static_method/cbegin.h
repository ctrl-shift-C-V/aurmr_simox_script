...
namespace simox::meta::member::static_method::cbegin::impl
{
...
namespace simox::meta::member::static_method::cbegin
{
...
{
    template<class T>
    static constexpr bool cbegin = ::simox::meta::member::static_method::cbegin::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept cbegin = ::simox::meta::member::static_method::cbegin::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using cbegin = simox::meta::member::static_method::cbegin::return_type_t<T>;
}
