...
namespace simox::meta::member::static_method::data::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::data));
...
namespace simox::meta::member::static_method::data
{
...
{
    template<class T>
    static constexpr bool data = ::simox::meta::member::static_method::data::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept data = ::simox::meta::member::static_method::data::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using data = simox::meta::member::static_method::data::return_type_t<T>;
}
