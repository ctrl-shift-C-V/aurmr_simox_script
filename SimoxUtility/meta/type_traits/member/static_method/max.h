...
namespace simox::meta::member::static_method::max::impl
{
...
namespace simox::meta::member::static_method::max
{
...
{
    template<class T>
    static constexpr bool max = ::simox::meta::member::static_method::max::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept max = ::simox::meta::member::static_method::max::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using max = simox::meta::member::static_method::max::return_type_t<T>;
}
