...
namespace simox::meta::member::static_method::min::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::min));
...
namespace simox::meta::member::static_method::min
{
...
{
    template<class T>
    static constexpr bool min = ::simox::meta::member::static_method::min::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept min = ::simox::meta::member::static_method::min::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using min = simox::meta::member::static_method::min::return_type_t<T>;
}
