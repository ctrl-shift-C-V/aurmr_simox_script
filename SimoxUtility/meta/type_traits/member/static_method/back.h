...
namespace simox::meta::member::static_method::back::impl
{
...
namespace simox::meta::member::static_method::back
{
...
{
    template<class T>
    static constexpr bool back = ::simox::meta::member::static_method::back::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept back = ::simox::meta::member::static_method::back::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using back = simox::meta::member::static_method::back::return_type_t<T>;
}
