...
namespace simox::meta::member::static_method::clear::impl
{
...
namespace simox::meta::member::static_method::clear
{
...
{
    template<class T>
    static constexpr bool clear = ::simox::meta::member::static_method::clear::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept clear = ::simox::meta::member::static_method::clear::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using clear = simox::meta::member::static_method::clear::return_type_t<T>;
}
