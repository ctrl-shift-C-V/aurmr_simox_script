...
namespace simox::meta::member::static_method::_0::impl
{
...
namespace simox::meta::member::static_method::_0
{
...
{
    template<class T>
    static constexpr bool _0 = ::simox::meta::member::static_method::_0::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept _0 = ::simox::meta::member::static_method::_0::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using _0 = simox::meta::member::static_method::_0::return_type_t<T>;
}
