...
namespace simox::meta::member::static_method::empty::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::empty));
...
namespace simox::meta::member::static_method::empty
{
...
{
    template<class T>
    static constexpr bool empty = ::simox::meta::member::static_method::empty::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept empty = ::simox::meta::member::static_method::empty::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using empty = simox::meta::member::static_method::empty::return_type_t<T>;
}
