...
namespace simox::meta::member::static_method::emplace::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::emplace));
...
namespace simox::meta::member::static_method::emplace
{
...
{
    template<class T>
    static constexpr bool emplace = ::simox::meta::member::static_method::emplace::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept emplace = ::simox::meta::member::static_method::emplace::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using emplace = simox::meta::member::static_method::emplace::return_type_t<T>;
}
