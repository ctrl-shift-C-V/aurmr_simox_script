...
namespace simox::meta::member::static_method::x::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::x));
...
namespace simox::meta::member::static_method::x
{
...
{
    template<class T>
    static constexpr bool x = ::simox::meta::member::static_method::x::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept x = ::simox::meta::member::static_method::x::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using x = simox::meta::member::static_method::x::return_type_t<T>;
}
