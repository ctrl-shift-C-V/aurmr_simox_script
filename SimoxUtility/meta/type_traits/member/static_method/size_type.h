...
namespace simox::meta::member::static_method::size_type::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::size_type));
...
namespace simox::meta::member::static_method::size_type
{
...
{
    template<class T>
    static constexpr bool size_type = ::simox::meta::member::static_method::size_type::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept size_type = ::simox::meta::member::static_method::size_type::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using size_type = simox::meta::member::static_method::size_type::return_type_t<T>;
}
