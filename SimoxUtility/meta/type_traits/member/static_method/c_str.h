...
namespace simox::meta::member::static_method::c_str::impl
{
...
namespace simox::meta::member::static_method::c_str
{
...
{
    template<class T>
    static constexpr bool c_str = ::simox::meta::member::static_method::c_str::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept c_str = ::simox::meta::member::static_method::c_str::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using c_str = simox::meta::member::static_method::c_str::return_type_t<T>;
}
