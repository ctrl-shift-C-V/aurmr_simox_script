...
namespace simox::meta::member::static_method::qy::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::qy));
...
namespace simox::meta::member::static_method::qy
{
...
{
    template<class T>
    static constexpr bool qy = ::simox::meta::member::static_method::qy::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept qy = ::simox::meta::member::static_method::qy::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using qy = simox::meta::member::static_method::qy::return_type_t<T>;
}
