...
namespace simox::meta::member::static_method::y::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::y));
...
namespace simox::meta::member::static_method::y
{
...
{
    template<class T>
    static constexpr bool y = ::simox::meta::member::static_method::y::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept y = ::simox::meta::member::static_method::y::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using y = simox::meta::member::static_method::y::return_type_t<T>;
}
