...
namespace simox::meta::member::static_method::qz::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::qz));
...
namespace simox::meta::member::static_method::qz
{
...
{
    template<class T>
    static constexpr bool qz = ::simox::meta::member::static_method::qz::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept qz = ::simox::meta::member::static_method::qz::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using qz = simox::meta::member::static_method::qz::return_type_t<T>;
}
