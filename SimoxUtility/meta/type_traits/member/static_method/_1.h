...
namespace simox::meta::member::static_method::_1::impl
{
...
namespace simox::meta::member::static_method::_1
{
...
{
    template<class T>
    static constexpr bool _1 = ::simox::meta::member::static_method::_1::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept _1 = ::simox::meta::member::static_method::_1::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using _1 = simox::meta::member::static_method::_1::return_type_t<T>;
}
