...
namespace simox::meta::member::static_method::val::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::val));
...
namespace simox::meta::member::static_method::val
{
...
{
    template<class T>
    static constexpr bool val = ::simox::meta::member::static_method::val::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept val = ::simox::meta::member::static_method::val::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using val = simox::meta::member::static_method::val::return_type_t<T>;
}
