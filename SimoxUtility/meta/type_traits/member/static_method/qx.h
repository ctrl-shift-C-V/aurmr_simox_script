...
namespace simox::meta::member::static_method::qx::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::qx));
...
namespace simox::meta::member::static_method::qx
{
...
{
    template<class T>
    static constexpr bool qx = ::simox::meta::member::static_method::qx::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept qx = ::simox::meta::member::static_method::qx::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using qx = simox::meta::member::static_method::qx::return_type_t<T>;
}
