...
namespace simox::meta::member::static_method::vertex::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::vertex));
...
namespace simox::meta::member::static_method::vertex
{
...
{
    template<class T>
    static constexpr bool vertex = ::simox::meta::member::static_method::vertex::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept vertex = ::simox::meta::member::static_method::vertex::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using vertex = simox::meta::member::static_method::vertex::return_type_t<T>;
}
