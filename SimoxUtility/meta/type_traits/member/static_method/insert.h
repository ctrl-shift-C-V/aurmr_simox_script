...
namespace simox::meta::member::static_method::insert::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::insert));
...
namespace simox::meta::member::static_method::insert
{
...
{
    template<class T>
    static constexpr bool insert = ::simox::meta::member::static_method::insert::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept insert = ::simox::meta::member::static_method::insert::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using insert = simox::meta::member::static_method::insert::return_type_t<T>;
}
