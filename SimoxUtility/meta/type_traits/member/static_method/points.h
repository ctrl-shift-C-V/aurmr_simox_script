...
namespace simox::meta::member::static_method::points::impl
{
...
namespace simox::meta::member::static_method::points
{
...
{
    template<class T>
    static constexpr bool points = ::simox::meta::member::static_method::points::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept points = ::simox::meta::member::static_method::points::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using points = simox::meta::member::static_method::points::return_type_t<T>;
}
