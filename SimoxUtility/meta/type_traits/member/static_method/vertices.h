...
namespace simox::meta::member::static_method::vertices::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::vertices));
...
namespace simox::meta::member::static_method::vertices
{
...
{
    template<class T>
    static constexpr bool vertices = ::simox::meta::member::static_method::vertices::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept vertices = ::simox::meta::member::static_method::vertices::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using vertices = simox::meta::member::static_method::vertices::return_type_t<T>;
}
