...
namespace simox::meta::member::static_method::second::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::second));
...
namespace simox::meta::member::static_method::second
{
...
{
    template<class T>
    static constexpr bool second = ::simox::meta::member::static_method::second::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept second = ::simox::meta::member::static_method::second::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using second = simox::meta::member::static_method::second::return_type_t<T>;
}
