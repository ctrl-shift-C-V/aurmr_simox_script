...
namespace simox::meta::member::static_method::first::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::first));
...
namespace simox::meta::member::static_method::first
{
...
{
    template<class T>
    static constexpr bool first = ::simox::meta::member::static_method::first::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept first = ::simox::meta::member::static_method::first::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using first = simox::meta::member::static_method::first::return_type_t<T>;
}
