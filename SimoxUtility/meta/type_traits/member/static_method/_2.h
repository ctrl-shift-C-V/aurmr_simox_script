...
namespace simox::meta::member::static_method::_2::impl
{
...
namespace simox::meta::member::static_method::_2
{
...
{
    template<class T>
    static constexpr bool _2 = ::simox::meta::member::static_method::_2::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept _2 = ::simox::meta::member::static_method::_2::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using _2 = simox::meta::member::static_method::_2::return_type_t<T>;
}
