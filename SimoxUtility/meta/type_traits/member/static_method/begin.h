...
namespace simox::meta::member::static_method::begin::impl
{
...
namespace simox::meta::member::static_method::begin
{
...
{
    template<class T>
    static constexpr bool begin = ::simox::meta::member::static_method::begin::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept begin = ::simox::meta::member::static_method::begin::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using begin = simox::meta::member::static_method::begin::return_type_t<T>;
}
