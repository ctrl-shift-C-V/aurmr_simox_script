...
namespace simox::meta::member::static_method::extract::impl
{
...
namespace simox::meta::member::static_method::extract
{
...
{
    template<class T>
    static constexpr bool extract = ::simox::meta::member::static_method::extract::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept extract = ::simox::meta::member::static_method::extract::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using extract = simox::meta::member::static_method::extract::return_type_t<T>;
}
