...
namespace simox::meta::member::static_method::npos::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::npos));
...
namespace simox::meta::member::static_method::npos
{
...
{
    template<class T>
    static constexpr bool npos = ::simox::meta::member::static_method::npos::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept npos = ::simox::meta::member::static_method::npos::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using npos = simox::meta::member::static_method::npos::return_type_t<T>;
}
