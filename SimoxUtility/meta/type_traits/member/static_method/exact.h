...
namespace simox::meta::member::static_method::exact::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::exact));
...
namespace simox::meta::member::static_method::exact
{
...
{
    template<class T>
    static constexpr bool exact = ::simox::meta::member::static_method::exact::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept exact = ::simox::meta::member::static_method::exact::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using exact = simox::meta::member::static_method::exact::return_type_t<T>;
}
