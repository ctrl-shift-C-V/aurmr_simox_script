...
namespace simox::meta::member::static_method::string::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::string));
...
namespace simox::meta::member::static_method::string
{
...
{
    template<class T>
    static constexpr bool string = ::simox::meta::member::static_method::string::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept string = ::simox::meta::member::static_method::string::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using string = simox::meta::member::static_method::string::return_type_t<T>;
}
