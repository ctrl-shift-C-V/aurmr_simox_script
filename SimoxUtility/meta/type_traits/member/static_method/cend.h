...
namespace simox::meta::member::static_method::cend::impl
{
...
namespace simox::meta::member::static_method::cend
{
...
{
    template<class T>
    static constexpr bool cend = ::simox::meta::member::static_method::cend::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept cend = ::simox::meta::member::static_method::cend::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using cend = simox::meta::member::static_method::cend::return_type_t<T>;
}
