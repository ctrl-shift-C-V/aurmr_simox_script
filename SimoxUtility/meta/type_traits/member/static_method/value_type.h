...
namespace simox::meta::member::static_method::value_type::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::value_type));
...
namespace simox::meta::member::static_method::value_type
{
...
{
    template<class T>
    static constexpr bool value_type = ::simox::meta::member::static_method::value_type::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept value_type = ::simox::meta::member::static_method::value_type::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using value_type = simox::meta::member::static_method::value_type::return_type_t<T>;
}
