...
namespace simox::meta::member::static_method::at::impl
{
...
namespace simox::meta::member::static_method::at
{
...
{
    template<class T>
    static constexpr bool at = ::simox::meta::member::static_method::at::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept at = ::simox::meta::member::static_method::at::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using at = simox::meta::member::static_method::at::return_type_t<T>;
}
