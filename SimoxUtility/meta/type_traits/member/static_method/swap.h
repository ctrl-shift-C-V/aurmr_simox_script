...
namespace simox::meta::member::static_method::swap::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::swap));
...
namespace simox::meta::member::static_method::swap
{
...
{
    template<class T>
    static constexpr bool swap = ::simox::meta::member::static_method::swap::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept swap = ::simox::meta::member::static_method::swap::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using swap = simox::meta::member::static_method::swap::return_type_t<T>;
}
