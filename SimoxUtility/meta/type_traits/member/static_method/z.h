...
namespace simox::meta::member::static_method::z::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::z));
...
namespace simox::meta::member::static_method::z
{
...
{
    template<class T>
    static constexpr bool z = ::simox::meta::member::static_method::z::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept z = ::simox::meta::member::static_method::z::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using z = simox::meta::member::static_method::z::return_type_t<T>;
}
