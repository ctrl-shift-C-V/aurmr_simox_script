...
namespace simox::meta::member::static_method::front::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::front));
...
namespace simox::meta::member::static_method::front
{
...
{
    template<class T>
    static constexpr bool front = ::simox::meta::member::static_method::front::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept front = ::simox::meta::member::static_method::front::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using front = simox::meta::member::static_method::front::return_type_t<T>;
}
