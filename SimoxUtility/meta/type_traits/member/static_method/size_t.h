...
namespace simox::meta::member::static_method::size_t::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::size_t));
...
namespace simox::meta::member::static_method::size_t
{
...
{
    template<class T>
    static constexpr bool size_t = ::simox::meta::member::static_method::size_t::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept size_t = ::simox::meta::member::static_method::size_t::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using size_t = simox::meta::member::static_method::size_t::return_type_t<T>;
}
