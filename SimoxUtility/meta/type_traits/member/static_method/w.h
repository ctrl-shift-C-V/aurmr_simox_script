...
namespace simox::meta::member::static_method::w::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::w));
...
namespace simox::meta::member::static_method::w
{
...
{
    template<class T>
    static constexpr bool w = ::simox::meta::member::static_method::w::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept w = ::simox::meta::member::static_method::w::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using w = simox::meta::member::static_method::w::return_type_t<T>;
}
