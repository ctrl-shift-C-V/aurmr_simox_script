...
namespace simox::meta::member::static_method::reserve::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::reserve));
...
namespace simox::meta::member::static_method::reserve
{
...
{
    template<class T>
    static constexpr bool reserve = ::simox::meta::member::static_method::reserve::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept reserve = ::simox::meta::member::static_method::reserve::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using reserve = simox::meta::member::static_method::reserve::return_type_t<T>;
}
