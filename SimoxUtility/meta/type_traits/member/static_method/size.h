...
namespace simox::meta::member::static_method::size::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::size));
...
namespace simox::meta::member::static_method::size
{
...
{
    template<class T>
    static constexpr bool size = ::simox::meta::member::static_method::size::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept size = ::simox::meta::member::static_method::size::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using size = simox::meta::member::static_method::size::return_type_t<T>;
}
