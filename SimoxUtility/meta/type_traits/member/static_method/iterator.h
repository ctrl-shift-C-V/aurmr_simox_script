...
namespace simox::meta::member::static_method::iterator::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::iterator));
...
namespace simox::meta::member::static_method::iterator
{
...
{
    template<class T>
    static constexpr bool iterator = ::simox::meta::member::static_method::iterator::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept iterator = ::simox::meta::member::static_method::iterator::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using iterator = simox::meta::member::static_method::iterator::return_type_t<T>;
}
