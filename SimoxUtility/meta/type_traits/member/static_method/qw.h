...
namespace simox::meta::member::static_method::qw::impl
{
    template<class RType, class...Ps>
    RType type_fn(RType(*)(Ps...));
    template<class T>
    using ret_t = decltype(type_fn(&T::qw));
...
namespace simox::meta::member::static_method::qw
{
...
{
    template<class T>
    static constexpr bool qw = ::simox::meta::member::static_method::qw::exists_v<T>;
}
//concept
namespace simox::meta::member::static_method::ccept
{
    template<class T>
    concept qw = ::simox::meta::member::static_method::qw::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::static_method::return_type_t
{
    template<class T>
    using qw = simox::meta::member::static_method::qw::return_type_t<T>;
}
