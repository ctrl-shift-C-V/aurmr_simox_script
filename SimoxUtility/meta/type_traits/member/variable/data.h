...
namespace simox::meta::member::variable::data::impl
{
...
namespace simox::meta::member::variable::data
{
...
{
    template<class T>
    static constexpr bool data = ::simox::meta::member::variable::data::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept data = ::simox::meta::member::variable::data::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using data = simox::meta::member::variable::data::type_t<T>;
}
