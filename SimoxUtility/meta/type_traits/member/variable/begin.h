...
namespace simox::meta::member::variable::begin::impl
{
...
namespace simox::meta::member::variable::begin
{
...
{
    template<class T>
    static constexpr bool begin = ::simox::meta::member::variable::begin::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept begin = ::simox::meta::member::variable::begin::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using begin = simox::meta::member::variable::begin::type_t<T>;
}
