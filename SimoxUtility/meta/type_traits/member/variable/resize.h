...
namespace simox::meta::member::variable::resize::impl
{
...
namespace simox::meta::member::variable::resize
{
...
{
    template<class T>
    static constexpr bool resize = ::simox::meta::member::variable::resize::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept resize = ::simox::meta::member::variable::resize::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using resize = simox::meta::member::variable::resize::type_t<T>;
}
