...
namespace simox::meta::member::variable::npos::impl
{
...
namespace simox::meta::member::variable::npos
{
...
{
    template<class T>
    static constexpr bool npos = ::simox::meta::member::variable::npos::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept npos = ::simox::meta::member::variable::npos::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using npos = simox::meta::member::variable::npos::type_t<T>;
}
