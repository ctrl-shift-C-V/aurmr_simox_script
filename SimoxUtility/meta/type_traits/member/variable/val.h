...
namespace simox::meta::member::variable::val::impl
{
...
namespace simox::meta::member::variable::val
{
...
{
    template<class T>
    static constexpr bool val = ::simox::meta::member::variable::val::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept val = ::simox::meta::member::variable::val::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using val = simox::meta::member::variable::val::type_t<T>;
}
