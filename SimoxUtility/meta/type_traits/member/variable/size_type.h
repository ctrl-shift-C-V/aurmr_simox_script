...
namespace simox::meta::member::variable::size_type::impl
{
...
namespace simox::meta::member::variable::size_type
{
...
{
    template<class T>
    static constexpr bool size_type = ::simox::meta::member::variable::size_type::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept size_type = ::simox::meta::member::variable::size_type::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using size_type = simox::meta::member::variable::size_type::type_t<T>;
}
