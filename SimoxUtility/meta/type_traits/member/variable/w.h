...
namespace simox::meta::member::variable::w::impl
{
...
namespace simox::meta::member::variable::w
{
...
{
    template<class T>
    static constexpr bool w = ::simox::meta::member::variable::w::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept w = ::simox::meta::member::variable::w::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using w = simox::meta::member::variable::w::type_t<T>;
}
