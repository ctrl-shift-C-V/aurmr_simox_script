...
namespace simox::meta::member::variable::exact::impl
{
...
namespace simox::meta::member::variable::exact
{
...
{
    template<class T>
    static constexpr bool exact = ::simox::meta::member::variable::exact::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept exact = ::simox::meta::member::variable::exact::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using exact = simox::meta::member::variable::exact::type_t<T>;
}
