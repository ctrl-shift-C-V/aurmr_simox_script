...
namespace simox::meta::member::variable::min::impl
{
...
namespace simox::meta::member::variable::min
{
...
{
    template<class T>
    static constexpr bool min = ::simox::meta::member::variable::min::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept min = ::simox::meta::member::variable::min::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using min = simox::meta::member::variable::min::type_t<T>;
}
