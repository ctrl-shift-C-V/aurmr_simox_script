...
namespace simox::meta::member::variable::first::impl
{
...
namespace simox::meta::member::variable::first
{
...
{
    template<class T>
    static constexpr bool first = ::simox::meta::member::variable::first::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept first = ::simox::meta::member::variable::first::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using first = simox::meta::member::variable::first::type_t<T>;
}
