...
namespace simox::meta::member::variable::z::impl
{
...
namespace simox::meta::member::variable::z
{
...
{
    template<class T>
    static constexpr bool z = ::simox::meta::member::variable::z::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept z = ::simox::meta::member::variable::z::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using z = simox::meta::member::variable::z::type_t<T>;
}
