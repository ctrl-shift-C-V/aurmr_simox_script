...
namespace simox::meta::member::variable::end::impl
{
...
namespace simox::meta::member::variable::end
{
...
{
    template<class T>
    static constexpr bool end = ::simox::meta::member::variable::end::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept end = ::simox::meta::member::variable::end::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using end = simox::meta::member::variable::end::type_t<T>;
}
