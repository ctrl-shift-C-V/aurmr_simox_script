...
namespace simox::meta::member::variable::qx::impl
{
...
namespace simox::meta::member::variable::qx
{
...
{
    template<class T>
    static constexpr bool qx = ::simox::meta::member::variable::qx::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept qx = ::simox::meta::member::variable::qx::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using qx = simox::meta::member::variable::qx::type_t<T>;
}
