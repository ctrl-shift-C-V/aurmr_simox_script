...
namespace simox::meta::member::variable::insert::impl
{
...
namespace simox::meta::member::variable::insert
{
...
{
    template<class T>
    static constexpr bool insert = ::simox::meta::member::variable::insert::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept insert = ::simox::meta::member::variable::insert::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using insert = simox::meta::member::variable::insert::type_t<T>;
}
