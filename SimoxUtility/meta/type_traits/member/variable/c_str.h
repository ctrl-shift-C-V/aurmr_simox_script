...
namespace simox::meta::member::variable::c_str::impl
{
...
namespace simox::meta::member::variable::c_str
{
...
{
    template<class T>
    static constexpr bool c_str = ::simox::meta::member::variable::c_str::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept c_str = ::simox::meta::member::variable::c_str::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using c_str = simox::meta::member::variable::c_str::type_t<T>;
}
