...
namespace simox::meta::member::variable::emplace::impl
{
...
namespace simox::meta::member::variable::emplace
{
...
{
    template<class T>
    static constexpr bool emplace = ::simox::meta::member::variable::emplace::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept emplace = ::simox::meta::member::variable::emplace::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using emplace = simox::meta::member::variable::emplace::type_t<T>;
}
