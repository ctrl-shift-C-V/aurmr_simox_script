...
namespace simox::meta::member::variable::extract::impl
{
...
namespace simox::meta::member::variable::extract
{
...
{
    template<class T>
    static constexpr bool extract = ::simox::meta::member::variable::extract::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept extract = ::simox::meta::member::variable::extract::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using extract = simox::meta::member::variable::extract::type_t<T>;
}
