...
namespace simox::meta::member::variable::qz::impl
{
...
namespace simox::meta::member::variable::qz
{
...
{
    template<class T>
    static constexpr bool qz = ::simox::meta::member::variable::qz::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept qz = ::simox::meta::member::variable::qz::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using qz = simox::meta::member::variable::qz::type_t<T>;
}
