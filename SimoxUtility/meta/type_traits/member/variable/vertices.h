...
namespace simox::meta::member::variable::vertices::impl
{
...
namespace simox::meta::member::variable::vertices
{
...
{
    template<class T>
    static constexpr bool vertices = ::simox::meta::member::variable::vertices::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept vertices = ::simox::meta::member::variable::vertices::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using vertices = simox::meta::member::variable::vertices::type_t<T>;
}
