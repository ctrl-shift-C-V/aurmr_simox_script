...
namespace simox::meta::member::variable::x::impl
{
...
namespace simox::meta::member::variable::x
{
...
{
    template<class T>
    static constexpr bool x = ::simox::meta::member::variable::x::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept x = ::simox::meta::member::variable::x::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using x = simox::meta::member::variable::x::type_t<T>;
}
