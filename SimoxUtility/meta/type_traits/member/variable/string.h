...
namespace simox::meta::member::variable::string::impl
{
...
namespace simox::meta::member::variable::string
{
...
{
    template<class T>
    static constexpr bool string = ::simox::meta::member::variable::string::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept string = ::simox::meta::member::variable::string::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using string = simox::meta::member::variable::string::type_t<T>;
}
