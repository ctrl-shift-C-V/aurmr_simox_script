...
namespace simox::meta::member::variable::empty::impl
{
...
namespace simox::meta::member::variable::empty
{
...
{
    template<class T>
    static constexpr bool empty = ::simox::meta::member::variable::empty::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept empty = ::simox::meta::member::variable::empty::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using empty = simox::meta::member::variable::empty::type_t<T>;
}
