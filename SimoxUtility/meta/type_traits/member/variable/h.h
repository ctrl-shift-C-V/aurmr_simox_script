...
namespace simox::meta::member::variable::h::impl
{
...
namespace simox::meta::member::variable::h
{
...
{
    template<class T>
    static constexpr bool h = ::simox::meta::member::variable::h::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept h = ::simox::meta::member::variable::h::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using h = simox::meta::member::variable::h::type_t<T>;
}
