...
namespace simox::meta::member::variable::points::impl
{
...
namespace simox::meta::member::variable::points
{
...
{
    template<class T>
    static constexpr bool points = ::simox::meta::member::variable::points::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept points = ::simox::meta::member::variable::points::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using points = simox::meta::member::variable::points::type_t<T>;
}
