...
namespace simox::meta::member::variable::size_t::impl
{
...
namespace simox::meta::member::variable::size_t
{
...
{
    template<class T>
    static constexpr bool size_t = ::simox::meta::member::variable::size_t::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept size_t = ::simox::meta::member::variable::size_t::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using size_t = simox::meta::member::variable::size_t::type_t<T>;
}
