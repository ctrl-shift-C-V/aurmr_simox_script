...
namespace simox::meta::member::variable::_2::impl
{
...
namespace simox::meta::member::variable::_2
{
...
{
    template<class T>
    static constexpr bool _2 = ::simox::meta::member::variable::_2::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept _2 = ::simox::meta::member::variable::_2::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using _2 = simox::meta::member::variable::_2::type_t<T>;
}
