...
namespace simox::meta::member::variable::front::impl
{
...
namespace simox::meta::member::variable::front
{
...
{
    template<class T>
    static constexpr bool front = ::simox::meta::member::variable::front::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept front = ::simox::meta::member::variable::front::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using front = simox::meta::member::variable::front::type_t<T>;
}
