...
namespace simox::meta::member::variable::second::impl
{
...
namespace simox::meta::member::variable::second
{
...
{
    template<class T>
    static constexpr bool second = ::simox::meta::member::variable::second::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept second = ::simox::meta::member::variable::second::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using second = simox::meta::member::variable::second::type_t<T>;
}
