...
namespace simox::meta::member::variable::push_front::impl
{
...
namespace simox::meta::member::variable::push_front
{
...
{
    template<class T>
    static constexpr bool push_front = ::simox::meta::member::variable::push_front::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept push_front = ::simox::meta::member::variable::push_front::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using push_front = simox::meta::member::variable::push_front::type_t<T>;
}
