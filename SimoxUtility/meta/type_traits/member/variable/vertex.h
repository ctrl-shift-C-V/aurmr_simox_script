...
namespace simox::meta::member::variable::vertex::impl
{
...
namespace simox::meta::member::variable::vertex
{
...
{
    template<class T>
    static constexpr bool vertex = ::simox::meta::member::variable::vertex::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept vertex = ::simox::meta::member::variable::vertex::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using vertex = simox::meta::member::variable::vertex::type_t<T>;
}
