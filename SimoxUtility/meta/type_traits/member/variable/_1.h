...
namespace simox::meta::member::variable::_1::impl
{
...
namespace simox::meta::member::variable::_1
{
...
{
    template<class T>
    static constexpr bool _1 = ::simox::meta::member::variable::_1::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept _1 = ::simox::meta::member::variable::_1::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using _1 = simox::meta::member::variable::_1::type_t<T>;
}
