...
namespace simox::meta::member::variable::point::impl
{
...
namespace simox::meta::member::variable::point
{
...
{
    template<class T>
    static constexpr bool point = ::simox::meta::member::variable::point::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept point = ::simox::meta::member::variable::point::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using point = simox::meta::member::variable::point::type_t<T>;
}
