...
namespace simox::meta::member::variable::emplace_back::impl
{
...
namespace simox::meta::member::variable::emplace_back
{
...
{
    template<class T>
    static constexpr bool emplace_back = ::simox::meta::member::variable::emplace_back::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept emplace_back = ::simox::meta::member::variable::emplace_back::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using emplace_back = simox::meta::member::variable::emplace_back::type_t<T>;
}
