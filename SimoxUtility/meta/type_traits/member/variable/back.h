...
namespace simox::meta::member::variable::back::impl
{
...
namespace simox::meta::member::variable::back
{
...
{
    template<class T>
    static constexpr bool back = ::simox::meta::member::variable::back::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept back = ::simox::meta::member::variable::back::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using back = simox::meta::member::variable::back::type_t<T>;
}
