...
namespace simox::meta::member::variable::reserve::impl
{
...
namespace simox::meta::member::variable::reserve
{
...
{
    template<class T>
    static constexpr bool reserve = ::simox::meta::member::variable::reserve::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept reserve = ::simox::meta::member::variable::reserve::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using reserve = simox::meta::member::variable::reserve::type_t<T>;
}
