...
namespace simox::meta::member::variable::value_t::impl
{
...
namespace simox::meta::member::variable::value_t
{
...
{
    template<class T>
    static constexpr bool value_t = ::simox::meta::member::variable::value_t::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept value_t = ::simox::meta::member::variable::value_t::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using value_t = simox::meta::member::variable::value_t::type_t<T>;
}
