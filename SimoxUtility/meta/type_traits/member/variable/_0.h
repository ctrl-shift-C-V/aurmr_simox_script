...
namespace simox::meta::member::variable::_0::impl
{
...
namespace simox::meta::member::variable::_0
{
...
{
    template<class T>
    static constexpr bool _0 = ::simox::meta::member::variable::_0::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept _0 = ::simox::meta::member::variable::_0::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using _0 = simox::meta::member::variable::_0::type_t<T>;
}
