...
namespace simox::meta::member::variable::value_type::impl
{
...
namespace simox::meta::member::variable::value_type
{
...
{
    template<class T>
    static constexpr bool value_type = ::simox::meta::member::variable::value_type::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept value_type = ::simox::meta::member::variable::value_type::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using value_type = simox::meta::member::variable::value_type::type_t<T>;
}
