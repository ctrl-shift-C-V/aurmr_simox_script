...
namespace simox::meta::member::variable::emplace_front::impl
{
...
namespace simox::meta::member::variable::emplace_front
{
...
{
    template<class T>
    static constexpr bool emplace_front = ::simox::meta::member::variable::emplace_front::exists_v<T>;
}
//concept
namespace simox::meta::member::variable::ccept
{
    template<class T>
    concept emplace_front = ::simox::meta::member::variable::emplace_front::exists_v<T>;
}
//type_t
namespace simox::meta::member::variable::type_t
{
    template<class T>
    using emplace_front = simox::meta::member::variable::emplace_front::type_t<T>;
}
