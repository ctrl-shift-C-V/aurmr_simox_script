...
namespace simox::meta::member::method::insert::impl
{
...
namespace simox::meta::member::method::insert
{
...
{
    template<class T>
    static constexpr bool insert = ::simox::meta::member::method::insert::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept insert = ::simox::meta::member::method::insert::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using insert = simox::meta::member::method::insert::return_type_t<T>;
}
