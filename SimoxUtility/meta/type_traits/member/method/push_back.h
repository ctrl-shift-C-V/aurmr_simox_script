...
namespace simox::meta::member::method::push_back::impl
{
...
namespace simox::meta::member::method::push_back
{
...
{
    template<class T>
    static constexpr bool push_back = ::simox::meta::member::method::push_back::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept push_back = ::simox::meta::member::method::push_back::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using push_back = simox::meta::member::method::push_back::return_type_t<T>;
}
