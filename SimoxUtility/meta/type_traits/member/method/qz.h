...
namespace simox::meta::member::method::qz::impl
{
...
namespace simox::meta::member::method::qz
{
...
{
    template<class T>
    static constexpr bool qz = ::simox::meta::member::method::qz::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept qz = ::simox::meta::member::method::qz::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using qz = simox::meta::member::method::qz::return_type_t<T>;
}
