...
namespace simox::meta::member::method::data::impl
{
...
namespace simox::meta::member::method::data
{
...
{
    template<class T>
    static constexpr bool data = ::simox::meta::member::method::data::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept data = ::simox::meta::member::method::data::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using data = simox::meta::member::method::data::return_type_t<T>;
}
