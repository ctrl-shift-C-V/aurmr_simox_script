...
namespace simox::meta::member::method::size_t::impl
{
...
namespace simox::meta::member::method::size_t
{
...
{
    template<class T>
    static constexpr bool size_t = ::simox::meta::member::method::size_t::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept size_t = ::simox::meta::member::method::size_t::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using size_t = simox::meta::member::method::size_t::return_type_t<T>;
}
