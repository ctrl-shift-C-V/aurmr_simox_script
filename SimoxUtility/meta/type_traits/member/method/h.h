...
namespace simox::meta::member::method::h::impl
{
...
namespace simox::meta::member::method::h
{
...
{
    template<class T>
    static constexpr bool h = ::simox::meta::member::method::h::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept h = ::simox::meta::member::method::h::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using h = simox::meta::member::method::h::return_type_t<T>;
}
