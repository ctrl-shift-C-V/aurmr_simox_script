...
namespace simox::meta::member::method::qw::impl
{
...
namespace simox::meta::member::method::qw
{
...
{
    template<class T>
    static constexpr bool qw = ::simox::meta::member::method::qw::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept qw = ::simox::meta::member::method::qw::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using qw = simox::meta::member::method::qw::return_type_t<T>;
}
