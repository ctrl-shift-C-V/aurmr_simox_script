...
namespace simox::meta::member::method::y::impl
{
...
namespace simox::meta::member::method::y
{
...
{
    template<class T>
    static constexpr bool y = ::simox::meta::member::method::y::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept y = ::simox::meta::member::method::y::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using y = simox::meta::member::method::y::return_type_t<T>;
}
