...
namespace simox::meta::member::method::resize::impl
{
...
namespace simox::meta::member::method::resize
{
...
{
    template<class T>
    static constexpr bool resize = ::simox::meta::member::method::resize::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept resize = ::simox::meta::member::method::resize::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using resize = simox::meta::member::method::resize::return_type_t<T>;
}
