...
namespace simox::meta::member::method::z::impl
{
...
namespace simox::meta::member::method::z
{
...
{
    template<class T>
    static constexpr bool z = ::simox::meta::member::method::z::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept z = ::simox::meta::member::method::z::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using z = simox::meta::member::method::z::return_type_t<T>;
}
