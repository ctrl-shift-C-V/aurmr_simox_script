...
namespace simox::meta::member::method::size_type::impl
{
...
namespace simox::meta::member::method::size_type
{
...
{
    template<class T>
    static constexpr bool size_type = ::simox::meta::member::method::size_type::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept size_type = ::simox::meta::member::method::size_type::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using size_type = simox::meta::member::method::size_type::return_type_t<T>;
}
