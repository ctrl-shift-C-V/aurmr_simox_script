...
namespace simox::meta::member::method::value_type::impl
{
...
namespace simox::meta::member::method::value_type
{
...
{
    template<class T>
    static constexpr bool value_type = ::simox::meta::member::method::value_type::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept value_type = ::simox::meta::member::method::value_type::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using value_type = simox::meta::member::method::value_type::return_type_t<T>;
}
