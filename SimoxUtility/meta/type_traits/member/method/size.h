...
namespace simox::meta::member::method::size::impl
{
...
namespace simox::meta::member::method::size
{
...
{
    template<class T>
    static constexpr bool size = ::simox::meta::member::method::size::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept size = ::simox::meta::member::method::size::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using size = simox::meta::member::method::size::return_type_t<T>;
}
