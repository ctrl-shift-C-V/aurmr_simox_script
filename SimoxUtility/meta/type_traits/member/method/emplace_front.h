...
namespace simox::meta::member::method::emplace_front::impl
{
...
namespace simox::meta::member::method::emplace_front
{
...
{
    template<class T>
    static constexpr bool emplace_front = ::simox::meta::member::method::emplace_front::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept emplace_front = ::simox::meta::member::method::emplace_front::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using emplace_front = simox::meta::member::method::emplace_front::return_type_t<T>;
}
