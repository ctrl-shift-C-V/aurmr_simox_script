...
namespace simox::meta::member::method::min::impl
{
...
namespace simox::meta::member::method::min
{
...
{
    template<class T>
    static constexpr bool min = ::simox::meta::member::method::min::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept min = ::simox::meta::member::method::min::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using min = simox::meta::member::method::min::return_type_t<T>;
}
