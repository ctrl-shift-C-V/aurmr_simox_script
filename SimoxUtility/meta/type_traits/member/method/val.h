...
namespace simox::meta::member::method::val::impl
{
...
namespace simox::meta::member::method::val
{
...
{
    template<class T>
    static constexpr bool val = ::simox::meta::member::method::val::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept val = ::simox::meta::member::method::val::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using val = simox::meta::member::method::val::return_type_t<T>;
}
