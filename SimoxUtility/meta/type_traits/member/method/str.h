...
namespace simox::meta::member::method::str::impl
{
...
namespace simox::meta::member::method::str
{
...
{
    template<class T>
    static constexpr bool str = ::simox::meta::member::method::str::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept str = ::simox::meta::member::method::str::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using str = simox::meta::member::method::str::return_type_t<T>;
}
