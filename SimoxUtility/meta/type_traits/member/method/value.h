...
namespace simox::meta::member::method::value::impl
{
...
namespace simox::meta::member::method::value
{
...
{
    template<class T>
    static constexpr bool value = ::simox::meta::member::method::value::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept value = ::simox::meta::member::method::value::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using value = simox::meta::member::method::value::return_type_t<T>;
}
