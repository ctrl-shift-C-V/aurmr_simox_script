...
namespace simox::meta::member::method::qx::impl
{
...
namespace simox::meta::member::method::qx
{
...
{
    template<class T>
    static constexpr bool qx = ::simox::meta::member::method::qx::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept qx = ::simox::meta::member::method::qx::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using qx = simox::meta::member::method::qx::return_type_t<T>;
}
