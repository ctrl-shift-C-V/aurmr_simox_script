...
namespace simox::meta::member::method::iterator::impl
{
...
namespace simox::meta::member::method::iterator
{
...
{
    template<class T>
    static constexpr bool iterator = ::simox::meta::member::method::iterator::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept iterator = ::simox::meta::member::method::iterator::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using iterator = simox::meta::member::method::iterator::return_type_t<T>;
}
