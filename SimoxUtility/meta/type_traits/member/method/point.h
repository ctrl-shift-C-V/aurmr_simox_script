...
namespace simox::meta::member::method::point::impl
{
...
namespace simox::meta::member::method::point
{
...
{
    template<class T>
    static constexpr bool point = ::simox::meta::member::method::point::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept point = ::simox::meta::member::method::point::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using point = simox::meta::member::method::point::return_type_t<T>;
}
