...
namespace simox::meta::member::method::swap::impl
{
...
namespace simox::meta::member::method::swap
{
...
{
    template<class T>
    static constexpr bool swap = ::simox::meta::member::method::swap::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept swap = ::simox::meta::member::method::swap::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using swap = simox::meta::member::method::swap::return_type_t<T>;
}
