...
namespace simox::meta::member::method::emplace::impl
{
...
namespace simox::meta::member::method::emplace
{
...
{
    template<class T>
    static constexpr bool emplace = ::simox::meta::member::method::emplace::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept emplace = ::simox::meta::member::method::emplace::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using emplace = simox::meta::member::method::emplace::return_type_t<T>;
}
