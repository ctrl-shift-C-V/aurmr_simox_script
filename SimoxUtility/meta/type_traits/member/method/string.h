...
namespace simox::meta::member::method::string::impl
{
...
namespace simox::meta::member::method::string
{
...
{
    template<class T>
    static constexpr bool string = ::simox::meta::member::method::string::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept string = ::simox::meta::member::method::string::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using string = simox::meta::member::method::string::return_type_t<T>;
}
