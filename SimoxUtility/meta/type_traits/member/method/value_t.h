...
namespace simox::meta::member::method::value_t::impl
{
...
namespace simox::meta::member::method::value_t
{
...
{
    template<class T>
    static constexpr bool value_t = ::simox::meta::member::method::value_t::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept value_t = ::simox::meta::member::method::value_t::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using value_t = simox::meta::member::method::value_t::return_type_t<T>;
}
