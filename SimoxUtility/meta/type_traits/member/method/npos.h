...
namespace simox::meta::member::method::npos::impl
{
...
namespace simox::meta::member::method::npos
{
...
{
    template<class T>
    static constexpr bool npos = ::simox::meta::member::method::npos::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept npos = ::simox::meta::member::method::npos::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using npos = simox::meta::member::method::npos::return_type_t<T>;
}
