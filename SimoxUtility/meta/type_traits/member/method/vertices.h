...
namespace simox::meta::member::method::vertices::impl
{
...
namespace simox::meta::member::method::vertices
{
...
{
    template<class T>
    static constexpr bool vertices = ::simox::meta::member::method::vertices::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept vertices = ::simox::meta::member::method::vertices::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using vertices = simox::meta::member::method::vertices::return_type_t<T>;
}
