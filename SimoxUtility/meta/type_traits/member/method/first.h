...
namespace simox::meta::member::method::first::impl
{
...
namespace simox::meta::member::method::first
{
...
{
    template<class T>
    static constexpr bool first = ::simox::meta::member::method::first::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept first = ::simox::meta::member::method::first::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using first = simox::meta::member::method::first::return_type_t<T>;
}
