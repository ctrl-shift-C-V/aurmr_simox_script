...
namespace simox::meta::member::method::push_front::impl
{
...
namespace simox::meta::member::method::push_front
{
...
{
    template<class T>
    static constexpr bool push_front = ::simox::meta::member::method::push_front::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept push_front = ::simox::meta::member::method::push_front::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using push_front = simox::meta::member::method::push_front::return_type_t<T>;
}
