...
namespace simox::meta::member::method::exact::impl
{
...
namespace simox::meta::member::method::exact
{
...
{
    template<class T>
    static constexpr bool exact = ::simox::meta::member::method::exact::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept exact = ::simox::meta::member::method::exact::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using exact = simox::meta::member::method::exact::return_type_t<T>;
}
