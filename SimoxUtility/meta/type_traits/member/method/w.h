...
namespace simox::meta::member::method::w::impl
{
...
namespace simox::meta::member::method::w
{
...
{
    template<class T>
    static constexpr bool w = ::simox::meta::member::method::w::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept w = ::simox::meta::member::method::w::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using w = simox::meta::member::method::w::return_type_t<T>;
}
