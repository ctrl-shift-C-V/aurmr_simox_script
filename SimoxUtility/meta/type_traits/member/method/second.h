...
namespace simox::meta::member::method::second::impl
{
...
namespace simox::meta::member::method::second
{
...
{
    template<class T>
    static constexpr bool second = ::simox::meta::member::method::second::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept second = ::simox::meta::member::method::second::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using second = simox::meta::member::method::second::return_type_t<T>;
}
