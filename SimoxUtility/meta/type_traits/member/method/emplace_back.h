...
namespace simox::meta::member::method::emplace_back::impl
{
...
namespace simox::meta::member::method::emplace_back
{
...
{
    template<class T>
    static constexpr bool emplace_back = ::simox::meta::member::method::emplace_back::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept emplace_back = ::simox::meta::member::method::emplace_back::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using emplace_back = simox::meta::member::method::emplace_back::return_type_t<T>;
}
