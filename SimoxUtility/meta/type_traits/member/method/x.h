...
namespace simox::meta::member::method::x::impl
{
...
namespace simox::meta::member::method::x
{
...
{
    template<class T>
    static constexpr bool x = ::simox::meta::member::method::x::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept x = ::simox::meta::member::method::x::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using x = simox::meta::member::method::x::return_type_t<T>;
}
