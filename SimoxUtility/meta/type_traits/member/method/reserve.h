...
namespace simox::meta::member::method::reserve::impl
{
...
namespace simox::meta::member::method::reserve
{
...
{
    template<class T>
    static constexpr bool reserve = ::simox::meta::member::method::reserve::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept reserve = ::simox::meta::member::method::reserve::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using reserve = simox::meta::member::method::reserve::return_type_t<T>;
}
