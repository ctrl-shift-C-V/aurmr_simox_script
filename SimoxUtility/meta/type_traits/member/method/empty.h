...
namespace simox::meta::member::method::empty::impl
{
...
namespace simox::meta::member::method::empty
{
...
{
    template<class T>
    static constexpr bool empty = ::simox::meta::member::method::empty::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept empty = ::simox::meta::member::method::empty::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using empty = simox::meta::member::method::empty::return_type_t<T>;
}
