...
namespace simox::meta::member::method::qy::impl
{
...
namespace simox::meta::member::method::qy
{
...
{
    template<class T>
    static constexpr bool qy = ::simox::meta::member::method::qy::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept qy = ::simox::meta::member::method::qy::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using qy = simox::meta::member::method::qy::return_type_t<T>;
}
