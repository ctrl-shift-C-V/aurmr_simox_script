...
namespace simox::meta::member::method::vertex::impl
{
...
namespace simox::meta::member::method::vertex
{
...
{
    template<class T>
    static constexpr bool vertex = ::simox::meta::member::method::vertex::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept vertex = ::simox::meta::member::method::vertex::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using vertex = simox::meta::member::method::vertex::return_type_t<T>;
}
