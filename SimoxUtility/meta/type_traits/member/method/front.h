...
namespace simox::meta::member::method::front::impl
{
...
namespace simox::meta::member::method::front
{
...
{
    template<class T>
    static constexpr bool front = ::simox::meta::member::method::front::exists_v<T>;
}
//concept
namespace simox::meta::member::method::ccept
{
    template<class T>
    concept front = ::simox::meta::member::method::front::exists_v<T>;
}
//return_type_t
namespace simox::meta::member::method::return_type_t
{
    template<class T>
    using front = simox::meta::member::method::front::return_type_t<T>;
}
