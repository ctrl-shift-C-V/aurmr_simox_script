...
namespace simox::math
{
    ...
    constexpr
    std::enable_if_t <simox::meta::are_arithmetic_v<L, R>, bool>
    is_less(std::array<L, 1> l, std::array<R, 1> r)
    {
        return is_less(l.at(0), r.at(0));
    }

    template<class L, class R>
    constexpr
    std::enable_if_t <simox::meta::are_arithmetic_v<L, R>, bool>
    is_less(std::array<L, 1> l, R r)
    {
        return is_less(l.at(0), r);
    }

    template<class L, class R>
    constexpr
    std::enable_if_t <simox::meta::are_arithmetic_v<L, R>, bool>
    is_less(L l, std::array<R, 1> r)
    {
        return is_less(l, r.at(0));
    }
}
