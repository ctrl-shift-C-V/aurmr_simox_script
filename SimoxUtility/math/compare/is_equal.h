...
namespace simox::math
{
    ...
    constexpr
    std::enable_if_t <simox::meta::are_arithmetic_v<L, R>, bool>
    is_equal(std::array<L, 1> l, std::array<R, 1> r)
    {
        return is_equal(l.at(0), r.at(0));
    }

    template<class L, class R>
    constexpr
    std::enable_if_t <simox::meta::are_arithmetic_v<L, R>, bool>
    is_equal(std::array<L, 1> l, R r)
    {
        return is_equal(l.at(0), r);
    }

    template<class L, class R>
    constexpr
    std::enable_if_t <simox::meta::are_arithmetic_v<L, R>, bool>
    is_equal(L l, std::array<R, 1> r)
    {
        return is_equal(l, r.at(0));
    }
}
